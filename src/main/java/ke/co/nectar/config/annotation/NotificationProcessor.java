package ke.co.nectar.config.annotation;

import ke.co.nectar.config.annotation.exception.InvalidTemplateException;
import ke.co.nectar.config.annotation.exception.UnImplementedAnnotationException;
import ke.co.nectar.config.response.ApiResponse;
import ke.co.nectar.config.utils.request.ApiResponseException;
import ke.co.nectar.config.utils.request.BasicAuthCredentials;
import ke.co.nectar.config.utils.request.Payload;
import ke.co.nectar.config.utils.request.RequestUtils;
